...
class MemoryStore2:
    def __init__(self, db_path: str | Path, vec_dim: int = VEC_DIM) -> None:
        ...
        self._db.commit()
        self.execution = ExecutionMemoryRepository(self._db, self._lock)
...
"""
    ...
    def mark_superseded(self, item_id: str) -> None:
        ...
        self._db.commit()
        self.execution.mark_superseded([item_id])
    ...
    def mark_superseded_batch(self, ids: list[str]) -> None:
        ...
        self._db.commit()
        self.execution.mark_superseded(ids)
